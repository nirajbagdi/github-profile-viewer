...
class ProfileView extends View {
	...
	_generateMarkup() {
		return `
            <div class="profile-intro--col1">
                <img
                    class="profile-intro--img"
                    src="${this._data.avatarUrl}"
                    alt="${this._data.username}"
                />
            </div>

            <div class="profile-intro--col2">
				<p class="profile-intro--title">${this._data.name}</p>
				...
				<p class="profile-intro--bio">
                    ${this._data.bio || 'This profile has no bio'}
                </p>

				<div class="profile-intro--links">
					<div class="flex profile-intro--link">
						...
						<a>${this._data.location}</a>
					</div>

					<div class="flex profile-intro--link ${!this._data.twitter && 'text-muted'}">
                        ...
                        ${
							this._data.twitter
								? `<a href="${this._data.twitter}" target="_blank">${this._data.twitter}</a>`
								: '<a>Not available</a>'
						}

					</div>

					<div class="flex profile-intro--link ${!this._data.blog && 'text-muted'}">
						...
						${
							this._data.blog
								? `<a href="${this._data.blog}" target="_blank">${this._data.blog}</a>`
								: '<a>Not available</a>'
						}
					</div>

					<div class="flex profile-intro--link ${!this._data.company && 'text-muted'}">
						<svg height="20" width="20" xmlns="http://www.w3.org/2000/svg">
							<g fill="#4b6a9b">
								<path
						...
						${
							this._data.company
								? `<a href="${this._data.company}" target="_blank">${this._data.company}</a>`
								: '<a>Not available</a>'
						}
					</div>
				</div>
